...
<body class="ux" ng-app="splashDemo" ng-controller="MainCtrl as main">
	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<a href="#" title="UX - Coming Soon HTML Template">
				<img src="assets/img/myadvertising.in-logo.png" alt="UX - Coming Soon HTML Template">
			</a>
		</section>
		<!-- Logo end here -->
		<!-- Slogan start here -->
		...
		<section class="newsletter row fade-down">      
            ...
            <div id="mc_embed_signup_scroll" class="form-group">
                <div><span class="email-ico"> <img src="assets/img/search-icon.png"></i> </span>
            	<input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Serach here to find awsome place for your ads" ng-click="main.openSplash()">        	</div>
            ...
            <div class="clear"><input type="submit" value="Search" name="Search" id="mc-embedded-subscribe" class="btn-submit"></div>
            </div>
        </form>
		</section>
		<!-- Newsletter end here -->
		...
		<ul class="connect-us row fade-down">
			<li><a href="https://goo.gl/byHBdY" class="fb tool-tip" title="Facebook"><i class="fa fa-facebook"></i></a></li>
			<li><a href="#" class="twitter tool-tip" title="Twitter"><i class="fa fa-twitter"></i></a></li>
			<li><a href="https://plus.google.com/112568317624756782120" class="gplus tool-tip" title="Google Plus"><i class="fa fa-google-plus"></i></a></li>
        ...
        <div class="clearfix cnt-wrap">
         <form id="contactform" name="contactform" action="" method="post">
         	<div id="result"></div>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 columns">
                <input type="text"  id="email" placeholder="Email" name="email" value="<?php echo $from;?>" ng-click="main.openSplash()" required>
              </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center columns">             
                <button name="submit" id="submit" class="contact-btn-submit" type="submit" ng-click="main.openSplash()">Send</button>
              </div> 
            </form>        
        </div>
